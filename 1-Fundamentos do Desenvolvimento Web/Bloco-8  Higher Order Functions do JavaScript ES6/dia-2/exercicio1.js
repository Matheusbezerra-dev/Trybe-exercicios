...
const getNamedBook = () => books.find((books) => books.name.length === 26);
...
const everyoneWasBornOnSecXX = () => books.every((element) => element.author.birthYear >= 1901 && element.author.birthYear < 1999);
